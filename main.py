...
cat_age = age/9
cat_age_years = int(cat_age / 1) #isolates horse years
cat_age_decimal = cat_age % 1 #isolates the decimal in the horse age 
...
mother_height = float(input("What is your mother's height in inches?\t"))
father_height = float(input("What is your father's height in inches?\t"))
estimated_height = 0
while estimated_height == 0:
...
print(first_name,"you are",age_years,"years old and your estimated height is",estimated_height,"inches.")